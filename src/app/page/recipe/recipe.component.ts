...
export class RecipeComponent {
  ...
  constructor(private service: RecipeService, private routes: ActivatedRoute) {
    this.routes.params.subscribe((paramMap) => {
      this.service.readRecipeAsync(paramMap['filename']).then(recipe => {
        this.recipe = recipe;
      });
    });
  }
